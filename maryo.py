...
#Import pygame,random,sys modules
...
black=(0,0,0)   #balck background color
white=(255,255,255)
blue=(0,0,255)
...
def flamehitsmario(playerrect,flames):
    #to check if flame has hit mario
    for f in flame_list:
...
topscore = 0
dragon = Dragon() # creating dragon object


while True:

    flame_list = []
    player = Maryo() #creating Maryo object
    ...
    #the main game loop
    while True:
        #checking for key press and reacting for that
